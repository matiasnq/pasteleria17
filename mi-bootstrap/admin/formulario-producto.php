    ...
    <!-- arriba -->
        ...
        ?>          
         ...
         <!-- lat der -->
          ...
          <a href="panel.php">Volver al listado</a>
          
          <form method="POST" action="producto-alta.php" enctype="multipart/form-data">
              <label for="titulo">Titulo:</label>
              <input name="titulo" id="titulo" type="text">
              
              <label for="detalle">Detalle:</label>
              <textarea name="detalle" id="detalle" cols="20" rows="5"></textarea>
            ...
            <input type="submit" value="Alta Nuevo Producto">              
